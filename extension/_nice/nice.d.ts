...
declare const component: <T extends ComponentPropertyDefinitions | undefined = undefined>(fn: (props: T, key?: string) => RenderFunctionReturn | void) => T extends undefined ? (props?: undefined, key?: string) => Component<T> : (props: T, key?: string) => T extends undefined ? () => Component<T> : (props: T, key?: string) => Component<T>;
